...
const Bubbles = () => {
  return (
    <div className="flex flex-none fixed opacity-5 min-h-screen">
      ...
      <div className="flex-auto w-40 h-40  rounded-full mx-48 my-96 bg-slate-500 md:bg-blue-500 md:mx-36 md:my-44 " />
      ...
      <div className="flex-auto w-3 h-3  rounded-full  my-96  bg-blue-700 bg-opacity-50 " />
      ...
      <div className="flex-auto w-24 h-24  rounded-full my-96  bg-blue-700 bg-opacity-50 " />
      ...
      <div className="flex-auto w-8 h-8  rounded-full -mx-96 my-96  bg-red-700 bg-opacity-50 " />
      ...
      <div className="flex-auto w-24 h-24  rounded-full mx-[40rem] my-[8rem]  bg-black-700 bg-opacity-50 " />
      <div className="flex-auto w-32 h-32  rounded-full -mx-[24rem] my-[2rem]  bg-slate-700 bg-opacity-50 " />
      <div className="flex-auto w-32 h-32  rounded-full mx-[2rem] my-[16rem]  bg-orange-700 bg-opacity-50 " />
      <div className="flex-auto w-80 h-80  rounded-full mx-[1rem] my-[16rem]  bg-blue-700 bg-opacity-50 text-xl"></div>
      <div className="flex-auto w-6 h-6  rounded-full -mx-[32rem] my-[16rem]  bg-green-700 bg-opacity-50 " />
      <div className="flex-auto w-4 h-4  rounded-full mx-[25rem] my-[24rem]  bg-red-700 bg-opacity-50 " />
      <div className="flex-auto w-4 h-4  rounded-full mx-[25rem] my-[24rem]  bg-blue-700 bg-opacity-50 " />
      ...
      <div className="flex-auto w-20 h-20  rounded-full mx-[20rem] my-[30rem]   bg-blue-700 bg-opacity-50 " />
      ...
      <div className="flex-auto w-80 h-80  rounded-full -mx-44 my-32  bg-blue-700 bg-opacity-50" />
